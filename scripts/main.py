...
def optimize_plate_detection():
    ...
    """
    device = torch.device('cuda:0' if torch.cuda.is_available() else print("GPU not available"))
    writer = SummaryWriter('runs/PlateDetector_optimized_5')
    ...
    # torch.save(model.state_dict(), "model_saves/Optimized.pt")
    print("That's it!")
